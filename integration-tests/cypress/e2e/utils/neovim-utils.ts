import type { RunExCommandOutput, RunLuaCodeOutput } from "@tui-sandbox/library/server"
...
export function setBufferLines(nvim: NeovimContext, lines: string[]): Cypress.Chainable<RunLuaCodeOutput> {
