local will_rename = require('yazi.lsp.embedded-lsp-file-operations.lsp-file-operations.will-rename')
local did_rename = require('yazi.lsp.embedded-lsp-file-operations.lsp-file-operations.did-rename')
